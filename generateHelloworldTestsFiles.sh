...
./scripts/generateHelloworldGoFiles.sh "$num_dirs"

# Compile Go files to WebAssembly
./scripts/generateWasmFiles.sh "helloworldwasmfiles_generated"

# Serialize the generated WebAssembly files
./generateSerialisedWasmTimeModules.sh "helloworldwasmfiles_generated"
